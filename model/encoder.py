...
class CFTransformerEncoderVN(Module):
    ...
    def forward(self, node_attr:Tensor, pos:Tensor, edge_index:Tensor, edge_feature:Tensor) -> Tensor:
...
class AttentionInteractionBlockVN(Module):
    def __init__(
        ...
        self.message_module = MessageModule(hidden_channels[0], 
                                            hidden_channels[1], 
                                            edge_channels, 
                                            edge_channels,
                                            hidden_channels[0], 
    ...
    def forward(self, x:Tensor, edge_index:Tensor, edge_feature:Tensor, edge_vector:Tensor) -> Tensor:
        """
        Args:
